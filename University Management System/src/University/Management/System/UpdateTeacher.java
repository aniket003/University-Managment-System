...
class UpdateTeacher implements ActionListener {
    ...
    UpdateTeacher(){
        ...
        id11=new JLabel("Course");
        id11.setBounds(50,420,150,30);
    ...
    public void actionPerformed(ActionEvent ae)
    {
    	 if(ae.getSource()==b){
             try{
                 conn con = new conn();
                 String str = "update teacher set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',aadhar='"+t10.getText()+"',course='"+t11.getText()+"',dept='"+t13.getText()+"' where  emp_id='"+t12.getText()+"'";
